...
<xsl:stylesheet
    ...
    <xsl:import href="../docbook4-xsl/fo/docbook.xsl"/>
                ...
                <fo:table-body>
                    <fo:table-row>
                        <fo:table-cell text-align="center">
                            ...
                            -->
                            <fo:block font-family="simsun" font-size="48pt" padding-before="10mm">
                                <xsl:value-of select="bookinfo/title"/>
                            </fo:block>
                            <fo:block font-family="simsun" font-size="32pt" padding-before="10mm">
                                <xsl:value-of select="bookinfo/subtitle"/>
                            </fo:block>
                            <fo:block font-family="simsun" font-size="16pt" padding="10mm">
        ...
        <xsl:variable name="Version">
            <xsl:choose>
                <xsl:when test="//releaseinfo">
                    <xsl:text>Powered by docbook and fop</xsl:text>
                </xsl:when>
                <xsl:otherwise>
                    <!-- nop -->
                </xsl:otherwise>
